...
### LW model parameterised with AC model posterior parameters 
...
### Import English diagnoses, population and test data from 2000 to 2015
# diagnoses
diags_f_max <- read.csv('data/england_data/diagnoses_f_max.csv') 
diags_f_min <- read.csv('data/england_data/diagnoses_f_min.csv')
diags_m_max <- read.csv('data/england_data/diagnoses_m_max.csv')
diags_m_min <- read.csv('data/england_data/diagnoses_m_min.csv') 
# tests
tests_f_max <- read.csv('data/england_data/tests_f_max.csv') 
tests_f_min <- read.csv('data/england_data/tests_f_min.csv')
tests_m_max <- read.csv('data/england_data/tests_m_max.csv')
tests_m_min <- read.csv('data/england_data/tests_m_min.csv')
# population
pop_f <- read.csv('data/england_data/population_f.csv') 
pop_m <- read.csv('data/england_data/population_m.csv')
...
### Define number of years for which we have data
...
for (i in 1:years){
  diag_rate_f_15_19_max[i,] <- rgamma(n_sample, diags_f_15_19_max[i]*pop_f_15_19[i]/100000)/pop_f_15_19[i]
...
### Load in the posterior parameter data
load("output/parameters/eng_posteriors.dat")

### AC model study posterior parameters import

p_att_symp <- theta[,1]
p_true_pos_f <- theta[,2]
p_true_pos_m <- theta[,3] 
p_false_pos_f <- theta[,4]
p_false_pos_m <- theta[,5] 
p_asymp_m <- theta[,6] 
p_asymp_f <- theta[,7] 
p_spon_rec_f <- theta[,8] 
p_spon_rec_m  <- theta[,9]
# convert three parameters to rates
att_symp <- -1*log(1-p_att_symp)
spon_rec_f <- -1*log(1-p_spon_rec_f)
spon_rec_m <- -1*log(1-p_spon_rec_m)

### sol_dyn, model_test_diag, test_diag_fun from https://github.com/joostsmid 
...
if(!require("mosaic")) install.packages("mosaic");library(grid)
...
### Run a nested loop to compute the solutions of the differential equations
for (j in 1:years){
  for (i in 1:n_sample){
    # maximum estimates
    # f_15_19
    ...
    # update the user on the progress of the loop
...
write.csv(inc_f_15_19_max,'output/eng_lw_model_posteriors_inc_f_15_19_max.csv')
write.csv(inc_f_15_19_min,'output/eng_lw_model_posteriors_inc_f_15_19_min.csv')
write.csv(inc_f_20_24_max,'output/eng_lw_model_posteriors_inc_f_20_24_max.csv')
write.csv(inc_f_20_24_min,'output/eng_lw_model_posteriors_inc_f_20_24_min.csv')
write.csv(inc_m_15_19_max,'output/eng_lw_model_posteriors_inc_m_15_19_max.csv')
write.csv(inc_m_15_19_min,'output/eng_lw_model_posteriors_inc_m_15_19_min.csv')
write.csv(inc_m_20_24_max,'output/eng_lw_model_posteriors_inc_m_20_24_max.csv')
write.csv(inc_m_20_24_min,'output/eng_lw_model_posteriors_inc_m_20_24_min.csv')
...
write.csv(foi_f_15_19_max,'output/eng_lw_model_posteriors_foi_f_15_19_max.csv')
write.csv(foi_f_15_19_min,'output/eng_lw_model_posteriors_foi_f_15_19_min.csv')
write.csv(foi_f_20_24_max,'output/eng_lw_model_posteriors_foi_f_20_24_max.csv')
write.csv(foi_f_20_24_min,'output/eng_lw_model_posteriors_foi_f_20_24_min.csv')
write.csv(foi_m_15_19_max,'output/eng_lw_model_posteriors_foi_m_15_19_max.csv')
write.csv(foi_m_15_19_min,'output/eng_lw_model_posteriors_foi_m_15_19_min.csv')
write.csv(foi_m_20_24_max,'output/eng_lw_model_posteriors_foi_m_20_24_max.csv')
write.csv(foi_m_20_24_min,'output/eng_lw_model_posteriors_foi_m_20_24_min.csv')
...
write.csv(scr_f_15_19_max,'output/eng_lw_model_posteriors_scr_f_15_19_max.csv')
write.csv(scr_f_15_19_min,'output/eng_lw_model_posteriors_scr_f_15_19_min.csv')
write.csv(scr_f_20_24_max,'output/eng_lw_model_posteriors_scr_f_20_24_max.csv')
write.csv(scr_f_20_24_min,'output/eng_lw_model_posteriors_scr_f_20_24_min.csv')
write.csv(scr_m_15_19_max,'output/eng_lw_model_posteriors_scr_m_15_19_max.csv')
write.csv(scr_m_15_19_min,'output/eng_lw_model_posteriors_scr_m_15_19_min.csv')
write.csv(scr_m_20_24_max,'output/eng_lw_model_posteriors_scr_m_20_24_max.csv')
write.csv(scr_m_20_24_min,'output/eng_lw_model_posteriors_scr_m_20_24_min.csv')
...
write.csv(prev_f_15_19_max,'output/eng_lw_model_posteriors_prev_f_15_19_max.csv')
write.csv(prev_f_15_19_min,'output/eng_lw_model_posteriors_prev_f_15_19_min.csv')
write.csv(prev_f_20_24_max,'output/eng_lw_model_posteriors_prev_f_20_24_max.csv')
write.csv(prev_f_20_24_min,'output/eng_lw_model_posteriors_prev_f_20_24_min.csv')
write.csv(prev_m_15_19_max,'output/eng_lw_model_posteriors_prev_m_15_19_max.csv')
write.csv(prev_m_15_19_min,'output/eng_lw_model_posteriors_prev_m_15_19_min.csv')
write.csv(prev_m_20_24_max,'output/eng_lw_model_posteriors_prev_m_20_24_max.csv')
write.csv(prev_m_20_24_min,'output/eng_lw_model_posteriors_prev_m_20_24_min.csv')
...
write.csv(inc_f_15_19_max_stats,'output/summary_stats/eng_lw_model_posteriors_inc_f_15_19_max_stats.csv')
write.csv(inc_f_15_19_min_stats,'output/summary_stats/eng_lw_model_posteriors_inc_f_15_19_min_stats.csv')
write.csv(inc_f_20_24_max_stats,'output/summary_stats/eng_lw_model_posteriors_inc_f_20_24_max_stats.csv')
write.csv(inc_f_20_24_min_stats,'output/summary_stats/eng_lw_model_posteriors_inc_f_20_24_min_stats.csv')
write.csv(inc_m_15_19_max_stats,'output/summary_stats/eng_lw_model_posteriors_inc_m_15_19_max_stats.csv')
write.csv(inc_m_15_19_min_stats,'output/summary_stats/eng_lw_model_posteriors_inc_m_15_19_min_stats.csv')
write.csv(inc_m_20_24_max_stats,'output/summary_stats/eng_lw_model_posteriors_inc_m_20_24_max_stats.csv')
write.csv(inc_m_20_24_min_stats,'output/summary_stats/eng_lw_model_posteriors_inc_m_20_24_min_stats.csv')
...
write.csv(foi_f_15_19_max_stats,'output/summary_stats/eng_lw_model_posteriors_foi_f_15_19_max_stats.csv')
write.csv(foi_f_15_19_min_stats,'output/summary_stats/eng_lw_model_posteriors_foi_f_15_19_min_stats.csv')
write.csv(foi_f_20_24_max_stats,'output/summary_stats/eng_lw_model_posteriors_foi_f_20_24_max_stats.csv')
write.csv(foi_f_20_24_min_stats,'output/summary_stats/eng_lw_model_posteriors_foi_f_20_24_min_stats.csv')
write.csv(foi_m_15_19_max_stats,'output/summary_stats/eng_lw_model_posteriors_foi_m_15_19_max_stats.csv')
write.csv(foi_m_15_19_min_stats,'output/summary_stats/eng_lw_model_posteriors_foi_m_15_19_min_stats.csv')
write.csv(foi_m_20_24_max_stats,'output/summary_stats/eng_lw_model_posteriors_foi_m_20_24_max_stats.csv')
write.csv(foi_m_20_24_min_stats,'output/summary_stats/eng_lw_model_posteriors_foi_m_20_24_min_stats.csv')
...
write.csv(scr_f_15_19_max_stats,'output/summary_stats/eng_lw_model_posteriors_scr_f_15_19_max_stats.csv')
write.csv(scr_f_15_19_min_stats,'output/summary_stats/eng_lw_model_posteriors_scr_f_15_19_min_stats.csv')
write.csv(scr_f_20_24_max_stats,'output/summary_stats/eng_lw_model_posteriors_scr_f_20_24_max_stats.csv')
write.csv(scr_f_20_24_min_stats,'output/summary_stats/eng_lw_model_posteriors_scr_f_20_24_min_stats.csv')
write.csv(scr_m_15_19_max_stats,'output/summary_stats/eng_lw_model_posteriors_scr_m_15_19_max_stats.csv')
write.csv(scr_m_15_19_min_stats,'output/summary_stats/eng_lw_model_posteriors_scr_m_15_19_min_stats.csv')
write.csv(scr_m_20_24_max_stats,'output/summary_stats/eng_lw_model_posteriors_scr_m_20_24_max_stats.csv')
write.csv(scr_m_20_24_min_stats,'output/summary_stats/eng_lw_model_posteriors_scr_m_20_24_min_stats.csv')
...
write.csv(prev_f_15_19_max_stats,'output/summary_stats/eng_lw_model_posteriors_prev_f_15_19_max_stats.csv')
write.csv(prev_f_15_19_min_stats,'output/summary_stats/eng_lw_model_posteriors_prev_f_15_19_min_stats.csv')
write.csv(prev_f_20_24_max_stats,'output/summary_stats/eng_lw_model_posteriors_prev_f_20_24_max_stats.csv')
write.csv(prev_f_20_24_min_stats,'output/summary_stats/eng_lw_model_posteriors_prev_f_20_24_min_stats.csv')
write.csv(prev_m_15_19_max_stats,'output/summary_stats/eng_lw_model_posteriors_prev_m_15_19_max_stats.csv')
write.csv(prev_m_15_19_min_stats,'output/summary_stats/eng_lw_model_posteriors_prev_m_15_19_min_stats.csv')
write.csv(prev_m_20_24_max_stats,'output/summary_stats/eng_lw_model_posteriors_prev_m_20_24_max_stats.csv')
write.csv(prev_m_20_24_min_stats,'output/summary_stats/eng_lw_model_posteriors_prev_m_20_24_min_stats.csv')
