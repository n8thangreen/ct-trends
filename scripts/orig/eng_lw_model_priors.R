...
### Define sample size (10,000 in the LW model paper)
n_sample <- 5000
...
# save parameters
write.csv(p_true_pos_f,'output/parameters/eng_lw_model_priors_p_true_pos_f.csv')
write.csv(p_true_pos_m,'output/parameters/eng_lw_model_priors_p_true_pos_m.csv')
write.csv(p_false_pos_f,'output/parameters/eng_lw_model_priors_p_false_pos_f.csv')
write.csv(p_false_pos_m,'output/parameters/eng_lw_model_priors_p_false_pos_m.csv')
...
spon_rec_f <- read.csv('data/england_data/chlamydia_two_exponentials_women.csv')[1:n_sample,1]
spon_rec_m <- read.csv('data/england_data/chlamydia_two_exponentials_men.csv')[1:n_sample,1]
# save parameters
write.csv(spon_rec_f,'output/parameters/eng_lw_model_priors_spon_rec_f.csv')
write.csv(spon_rec_m,'output/parameters/eng_lw_model_priors_spon_rec_m.csv')

### Parameter for rate of treatment seeking per year (att_symp)
# R code from https://github.com/joostsmid
...
# save parameter
write.csv(att_symp,'output/parameters/eng_lw_model_priors_att_symp.csv')

### Parameters for proportion of infections asymptomatic (p_asymp)
# data from table 2 of the 2017 LW model paper
library(rriskDistributions)
p_asymp_f_alpha <- get.beta.par(p = c(0.025, 0.975), q = c(0.468, 0.752), plot = FALSE)[1]
p_asymp_f_beta <- get.beta.par(p = c(0.025, 0.975), q = c(0.468, 0.752), plot = FALSE)[2]
p_asymp_f <- rbeta(n_sample, shape1 = p_asymp_f_alpha, shape2 = p_asymp_f_beta)
p_asymp_m_alpha <- get.beta.par(p = c(0.025, 0.975), q = c(0.264, 0.759), plot = FALSE)[1]
p_asymp_m_beta <- get.beta.par(p = c(0.025, 0.975), q = c(0.264, 0.759), plot = FALSE)[2]
p_asymp_m <- rbeta(n_sample, shape1 = p_asymp_m_alpha, shape2 = p_asymp_m_beta)
# save parameters
write.csv(p_asymp_f,'output/parameters/eng_lw_model_priors_p_asymp_f.csv')
write.csv(p_asymp_m,'output/parameters/eng_lw_model_priors_p_asymp_m.csv')
...
write.csv(inc_f_15_19_max_stats,'output/summary_stats/eng_lw_model_priors_inc_f_15_19_max_stats.csv')
write.csv(inc_f_15_19_min_stats,'output/summary_stats/eng_lw_model_priors_inc_f_15_19_min_stats.csv')
write.csv(inc_f_20_24_max_stats,'output/summary_stats/eng_lw_model_priors_inc_f_20_24_max_stats.csv')
write.csv(inc_f_20_24_min_stats,'output/summary_stats/eng_lw_model_priors_inc_f_20_24_min_stats.csv')
write.csv(inc_m_15_19_max_stats,'output/summary_stats/eng_lw_model_priors_inc_m_15_19_max_stats.csv')
write.csv(inc_m_15_19_min_stats,'output/summary_stats/eng_lw_model_priors_inc_m_15_19_min_stats.csv')
write.csv(inc_m_20_24_max_stats,'output/summary_stats/eng_lw_model_priors_inc_m_20_24_max_stats.csv')
write.csv(inc_m_20_24_min_stats,'output/summary_stats/eng_lw_model_priors_inc_m_20_24_min_stats.csv')
...
write.csv(foi_f_15_19_max_stats,'output/summary_stats/eng_lw_model_priors_foi_f_15_19_max_stats.csv')
write.csv(foi_f_15_19_min_stats,'output/summary_stats/eng_lw_model_priors_foi_f_15_19_min_stats.csv')
write.csv(foi_f_20_24_max_stats,'output/summary_stats/eng_lw_model_priors_foi_f_20_24_max_stats.csv')
write.csv(foi_f_20_24_min_stats,'output/summary_stats/eng_lw_model_priors_foi_f_20_24_min_stats.csv')
write.csv(foi_m_15_19_max_stats,'output/summary_stats/eng_lw_model_priors_foi_m_15_19_max_stats.csv')
write.csv(foi_m_15_19_min_stats,'output/summary_stats/eng_lw_model_priors_foi_m_15_19_min_stats.csv')
write.csv(foi_m_20_24_max_stats,'output/summary_stats/eng_lw_model_priors_foi_m_20_24_max_stats.csv')
write.csv(foi_m_20_24_min_stats,'output/summary_stats/eng_lw_model_priors_foi_m_20_24_min_stats.csv')
...
write.csv(scr_f_15_19_max_stats,'output/summary_stats/eng_lw_model_priors_scr_f_15_19_max_stats.csv')
write.csv(scr_f_15_19_min_stats,'output/summary_stats/eng_lw_model_priors_scr_f_15_19_min_stats.csv')
write.csv(scr_f_20_24_max_stats,'output/summary_stats/eng_lw_model_priors_scr_f_20_24_max_stats.csv')
write.csv(scr_f_20_24_min_stats,'output/summary_stats/eng_lw_model_priors_scr_f_20_24_min_stats.csv')
write.csv(scr_m_15_19_max_stats,'output/summary_stats/eng_lw_model_priors_scr_m_15_19_max_stats.csv')
write.csv(scr_m_15_19_min_stats,'output/summary_stats/eng_lw_model_priors_scr_m_15_19_min_stats.csv')
write.csv(scr_m_20_24_max_stats,'output/summary_stats/eng_lw_model_priors_scr_m_20_24_max_stats.csv')
write.csv(scr_m_20_24_min_stats,'output/summary_stats/eng_lw_model_priors_scr_m_20_24_min_stats.csv')
...
write.csv(prev_f_15_19_max_stats,'output/summary_stats/eng_lw_model_priors_prev_f_15_19_max_stats.csv')
write.csv(prev_f_15_19_min_stats,'output/summary_stats/eng_lw_model_priors_prev_f_15_19_min_stats.csv')
write.csv(prev_f_20_24_max_stats,'output/summary_stats/eng_lw_model_priors_prev_f_20_24_max_stats.csv')
write.csv(prev_f_20_24_min_stats,'output/summary_stats/eng_lw_model_priors_prev_f_20_24_min_stats.csv')
write.csv(prev_m_15_19_max_stats,'output/summary_stats/eng_lw_model_priors_prev_m_15_19_max_stats.csv')
write.csv(prev_m_15_19_min_stats,'output/summary_stats/eng_lw_model_priors_prev_m_15_19_min_stats.csv')
write.csv(prev_m_20_24_max_stats,'output/summary_stats/eng_lw_model_priors_prev_m_20_24_max_stats.csv')
write.csv(prev_m_20_24_min_stats,'output/summary_stats/eng_lw_model_priors_prev_m_20_24_min_stats.csv')
